...
NOTE: If you have a copy of Sarsoft, map tiles, and TrackerDownloder already on your local computer then use that in place of "Sarsoft USB stick" in these instructions.

START SARSOFT:
Sarsoft directory from the Sarsoft USB strick or from your local Sarsoft folder if you have it.
...
NOTE: Maps save to the Sarsoft folder on the USB stick or local Sarsoft directory
